...
import { Search, Plus, Download, Edit, Trash2, Tag } from "lucide-react"
...
export default function ServiceListPage() {
  const { services, updateService, deleteService, promotions, getActivePromotions } = useAppContext()
  const [categories] = useState<ServiceCategory[]>(mockCategories)
  const [selectedCategory, setSelectedCategory] = useState<string>("all") // Изменено на "all" по умолчанию
